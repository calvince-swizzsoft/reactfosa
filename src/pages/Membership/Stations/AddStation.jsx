...
export default function AddStation({ open, onClose, refresh }) {
    ...
    useEffect(() => {
        if (form.ZoneId) {
            ...
            if (z) {
                update("ZoneDivisionId", z.DivisionId);
                update("ZoneDivisionEmployerId", z.DivisionEmployerId);
            }
        }
    }, [form.ZoneId]);
                    ...
                    >
                        <div className="bg-gray-200 m-2 rounded-xl">
                            ...
                            <div className="p-4 flex justify-between items-center bg-indigo-700 rounded-2xl m-2">
                                <h2 className="font-bold text-xl text-white">Add New Station</h2>
                            ...
                            {/* Form */}
                            <div className="p-5 overflow-y-auto h-[70vh] bg-gray-50 rounded-xl m-3">
