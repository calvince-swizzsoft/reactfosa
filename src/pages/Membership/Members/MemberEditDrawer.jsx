    ...
    useEffect(() => {
        if (member && open) {
            ...
            setCustomer({
                ...
                NonIndividualDescription: member.nonIndividualDescription || "",
                NonIndividualRegistrationNumber: member.nonIndividualRegistrationNumber || "",
                NonIndividualRegistrationSerialNumber: member.nonIndividualRegistrationSerialNumber || "",
                NonIndividualDateEstablished: member.nonIndividualDateEstablished?.split("T")[0] || "",
