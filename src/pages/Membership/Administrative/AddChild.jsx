...
export default function AddChild({ open, onClose, refresh, parent }) {
        ...
        try {
            const response = await fetch(
                `${import.meta.env.VITE_APP_MEMBERSHIP_URL}/api/administration/administrative-divisions`,
                {
                    ...
                    body: JSON.stringify({
                        parentId: parent.Id, // Child is linked to parent
            ...
            if (!response.ok) throw new Error("Failed to add child division");

            Swal.fire("Success!", "Child division added successfully", "success");
            refresh();
            onClose();
                    ...
                    >
                        ...
                        <div className="p-4 flex justify-between items-center bg-indigo-700 rounded-2xl m-2">
                            <h2 className="font-bold text-xl text-white">
                                Add Child Division to {parent.Description}
                            </h2>
