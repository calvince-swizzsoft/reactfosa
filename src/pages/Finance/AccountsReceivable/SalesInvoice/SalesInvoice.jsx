...
export default function SalesInvoice() {
  ...
  const fetchInvoices = () => {
    apiJson(`${import.meta.env.VITE_APP_FIN_URL}/api/values/GetSalesInvoices`, {
      ...
      .catch((error) => {
        setInvoices([]);
        Swal.fire("Error", apiErrorMessage(error, "Unable to load sales invoices."), "error");
      })
  ...
  const handlePostInvoice = async (invoiceId) => {
    try {
      ...
      Swal.fire("Error!", apiErrorMessage(err, "Unable to post the sales invoice."), "error");
    }
  };
