...
export default function LoanDetailsDrawer({ open, onClose, loan }) {
    ...
    return (
        <>
            <AnimatePresence>
                {open && (
                    <>
                        ...
                        {/* MAIN LOAN DETAILS DRAWER */}
                        <motion.div
                            className="fixed top-3 right-3 w-[85vw] max-w-[900px]
                            bg-white shadow-2xl z-50 rounded-2xl
                            flex flex-col overflow-y-auto max-h-[90vh]"
                            initial={{ x: "100%" }}
                            animate={{ x: 0 }}
                            exit={{ x: "100%" }}
                        ...
                        >
                            <div className="p-3 m-1 space-y-4">
                                ...
                                {/* Header */}
                                <div className="flex justify-between bg-indigo-600
                                    p-2 rounded-2xl mb-2 text-white font-semibold">
                                ...
                                <div className="bg-gray-50 p-4 rounded-lg shadow border space-y-2">
                                    <h3 className="font-bold text-white bg-gray-600
                                        p-2 pl-4 rounded-lg mb-4">
                                ...
                                {/* Financial Appraisal */}
                                <div className="bg-gray-50 p-4 rounded-lg shadow border space-y-4">
                                    <h3 className="font-bold text-white bg-gray-600
                                        p-2 pl-4 rounded-lg">
                                        Financial Appraisal
                                    </h3>
            ...
            {/* SECOND DRAWER — CALCULATOR & SCHEDULE */}
            {/* <LoanScheduleDrawer
                open={openCalculator}
