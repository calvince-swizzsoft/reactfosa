      ...
      {rows.map((row, index) => (
        <div key={index} className="grid grid-cols-12 gap-2 items-end rounded-lg border border-gray-200 p-2">
          <div className="col-span-4">
            <Label className="text-xs text-gray-500">G/L Account</Label>
          ...
          <div className="col-span-2">
            ...
            <Input type="number" min="0" max="100" value={row.Percentage} onChange={(e) => updateRow(index, { Percentage: Number(e.target.value) })} />
          </div>
          {showLeviable && (
