...
export default function MemberInfoTab({ customer, age }) {
    ...
    const handlePrintPDF = () => {
        ...
        drawSection("Personal Details", [
            ...
            { label: "Age", value: age },
            // { label: "Classification", value: customer.IndividualClassificationDescription },
        ...
        drawSection("Employment & Station", [
            ...
            { label: "Station", value: customer.StationDescription },
            { label: "Zone", value: customer.StationZoneDescription },
            { label: "Division", value: customer.StationZoneDivisionDescription },
            { label: "Employer", value: customer.StationZoneDivisionEmployerDescription },
        ]);

        drawSection("Contact & Address", [
            { label: "Mobile", value: customer.AddressMobileLine },
            { label: "Landline", value: customer.AddressLandLine },
    ...
    return (
        <>
            ...
            <Section title="Personal Details">
                ...
                {/* <Field label="Classification" value={customer.IndividualClassificationDescription} /> */}
            ...
            {/* <Section title="Employment & Station">
                ...
                <Field label="Station" value={customer.StationDescription} />
                <Field label="Zone" value={customer.StationZoneDescription} />
                <Field label="Division" value={customer.StationZoneDivisionDescription} />
                <Field label="Employer" value={customer.StationZoneDivisionEmployerDescription} />
            </Section> */}

            <Section title="Contact & Address">
                <Field label="Mobile" value={customer.AddressMobileLine} />
                {/* <Field label="Landline" value={customer.AddressLandLine} /> */}
