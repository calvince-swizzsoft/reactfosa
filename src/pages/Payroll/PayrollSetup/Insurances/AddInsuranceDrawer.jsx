...
export default function AddInsuranceDrawer({ open, onClose, onSuccess }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.error(err);
      Swal.fire("Error", "Failed to add insurance company.", "error");
    } finally {
      setLoading(false);
    }
  };
        ...
        <>
          ...
          >
            ...
            <div className="p-4 flex justify-between items-center bg-indigo-600 rounded-2xl m-2">
              <h2 className="font-bold text-lg text-white">Add Insurance Company</h2>
