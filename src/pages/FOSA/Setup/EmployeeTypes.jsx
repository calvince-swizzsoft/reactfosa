...
function CoaSelect({ label, value, onChange, coaList, disabled }) {
  return (
    <Field label={label}>
...
function EmployeeTypeForm({ form, setForm, coaList, loading, loadingData, submitLabel, onSubmit }) {
  ...
  return (
    <form onSubmit={onSubmit} className="p-4 space-y-4">
      ...
      <CoaSelect label="Chart of Account" value={form.ChartOfAccountId} onChange={handleChange} coaList={coaList} disabled={loadingData} />
      <div>
...
function EditEmployeeTypeDrawer({ open, onClose, onSuccess, item }) {
  ...
  return (
    <DrawerShell open={open} onClose={onClose} title="Edit Employee Type">
    ...
    <div>
      ...
      {loading ? (
        ...
        <div className="text-center mt-4">
          ...
          <p className="text-gray-400 mt-2">No employee types found.</p>
        </div>
      )}
