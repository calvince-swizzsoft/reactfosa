...
const screens = { form4: Form4, form3: Form3, form2: Form2, form1: Form1, form6: Form6, form7: Form7 };

export default function SasraSetup() {
  const [rows, setRows] = useState(() => availableReportRows([])), [selected, setSelected] = useState(null);
  ...
  useEffect(() => {
    ...
    async function load() {
      ...
      if (active) setRows(availableReportRows(versions));
    }
  ...
  return <main className="bg-white m-8 px-8 py-8 shadow-2xl rounded-lg relative">
    ...
    <div className="bg-gray-200 p-4 rounded-sm">
      ...
      {!loading && !error && !rows.length && <div className="text-center py-6"><img src="/assets/scopefinding.png" alt="" className="mx-auto w-32" /><p className="text-gray-400">No saved SASRA reports.</p></div>}
    </div>
