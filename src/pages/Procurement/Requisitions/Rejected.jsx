...
export default function Rejected() {
  ...
  const fetchRequisitions = () => {
    fetch(
      `${import.meta.env.VITE_APP_PRO_URL}/api/requisitions/getAllByStatus?status=Rejected`,
            ...
            {requisitions.map((req) => (
              ...
              >
                ...
                <div className="grid grid-cols-6 gap-2 items-center py-4 px-6 hover:shadow-xl transition-all">
                  ...
                  <span className="text-sm w-28 rounded-2xl text-center flex items-center justify-center p-1 bg-red-600 text-white">
                    {req.Status}
                  </span>
